  ...
  render() {
    return (
      <div className="card-box red">
        <div className="heading-top d-flex justify-content-between">
        ...
        >
          <div className="image-overflow">
            <div className="elem-1">
              <span className="red">Refugee</span>
